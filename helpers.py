...
def get_training_arguments():
    ...
    arg_parser.add_argument('--dataset_size', '-n', metavar = 'TRAIN_DATA_SIZE', nargs = '?', const = 64, default = 64, type = int, help = 'Number of images which will be used as training data.')
    ...
    arg_parser.add_argument('--output_path', '-o', metavar = 'MODEL_OUTPUT_PATH', nargs = '?', const = './', default = './', type = str, help = 'Path to which the trained SGAN model should be saved.')
